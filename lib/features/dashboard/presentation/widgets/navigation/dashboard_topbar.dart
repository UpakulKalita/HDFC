                    ...
                    children: [
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          child: SizedBox(
                            width: 48,
                            height: 46, // Reduced from 48 to match container
                            child: Icon(
    ...
    return MouseRegion(
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          duration: AppColors.durationShort,
          width: 48, // Matched search button width
          height: 46, // Matched search button height
          decoration: BoxDecoration(
            gradient: LinearGradient(
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ...
            borderRadius: BorderRadius.circular(30), // Match search radius
            border: Border.all(
              color: _isHovering ? AppColors.navyBlue.withOpacity(0.2) : Colors.white.withOpacity(0.5),
            ),
            boxShadow: [
              BoxShadow(
          ...
          child: Stack(
            ...
            children: [
              Icon(
                LucideIcons.bell,
                size: 20, // Increased to match search icon
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: const [
                                  Icon(LucideIcons.logOut, size: 16, color: Color(0xFFEF4444)),
                                  SizedBox(width: 8),
                                  Text(
                                    "Sign Out",
                                    style: TextStyle(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(30),
              border: Border.all(
                 color: _isHovering || _isMenuOpen ? AppColors.navyBlue.withOpacity(0.2) : Colors.white.withOpacity(0.5)
              ),
              boxShadow: [
                BoxShadow(
                ...
                if (!widget.isCompact) ...[
                  ...
                  AnimatedRotation(
                    ...
                    child: Icon(
                      ...
                      size: 16,
                      color: _isHovering || _isMenuOpen ? AppColors.primaryBlue : Colors.grey[600],
                    ),
                  ),
                ],
              ],
