...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget _buildStatsCards(double screenWidth) {
    int crossAxisCount = screenWidth > 1200 ? 3 : (screenWidth > 600 ? 2 : 1);
    double spacing = 16.0;
        ...
        return Wrap(
          ...
          children: [
            ...
            _buildStatCard(
              ...
              title: 'No. of recommended Policies',
              value: '5',
              color: Colors.green,
              width: (constraints.maxWidth - (crossAxisCount - 1) * spacing) / crossAxisCount,
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
            onTap: () => Navigator.push(context, PageRouteBuilder(pageBuilder: (_, __, ___) => const MyPoliciesPage(), transitionDuration: Duration.zero)),
            borderRadius: BorderRadius.circular(12),
            child: _buildQuickActionItem(
              icon: Icons.policy,
              title: 'My Policies',
          ...
          const SizedBox(height: 12),
          InkWell(
            onTap: () => Navigator.push(context, PageRouteBuilder(pageBuilder: (_, __, ___) => const GetHelpPage(), transitionDuration: Duration.zero)),
            borderRadius: BorderRadius.circular(12),
            child: _buildQuickActionItem(
              icon: Icons.help,
              title: 'FAQs',
