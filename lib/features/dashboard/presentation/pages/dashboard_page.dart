...
import 'package:insurance_flutter/features/dashboard/presentation/widgets/coverage_analysis/presentation/coverage_analysis_widget.dart';
                ...
                child: Column(
                  children: [
                    TopBarWidget(
                      ...
                      isDesktop: isDesktop,
                      activeItem: 'Dashboard',
                      automaticallyImplyLeading: false, // Remove back button but keep alignment
                    ),
                    Expanded(
        ...
        if (useVerticalLayout)
          Column(
            ...
            children: [
              ...
              CoverageAnalysisWidget(metrics: provider.metrics)
                  .animate()
