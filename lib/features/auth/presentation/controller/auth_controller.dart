...
import 'package:insurance_flutter/features/auth/data/repositories/mock_auth_repository_impl.dart';
...
class AuthController extends ChangeNotifier {
  ...
  AuthController({AuthRepository? repository}) 
      : _authRepository = repository ?? MockAuthRepositoryImpl() { // Swapped for testing 
