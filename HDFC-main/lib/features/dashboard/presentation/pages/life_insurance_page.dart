...
class _LifeInsurancePageState extends State<LifeInsurancePage> {
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Comprehensive life coverage with investment benefits',
                                    style: GoogleFonts.inter(
                                      fontSize: 16,
            ...
            Expanded(
              child: TextField(
                decoration: InputDecoration(
                  hintText: isDesktop ? 'Search life insurance...' : 'Search...',
  ...
  Widget _buildLifeInsuranceCard({
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Coverage: $coverage • Maturity: $maturity',
            style: GoogleFonts.inter(
              fontSize: 14,
              color: Colors.grey[600],
